...
def launch_gui() -> None:
    ...
    rb_riverd = _rb(rb_row, "RiverD  mode", "riverd", mode_var)
    rb_wdf.pack(side="left", padx=(0, 24))
    rb_txt.pack(side="left", padx=(0, 24))
    rb_riverd.pack(side="left")
    ...
    def _refresh_path_panel():
        ...
        elif mode_var.get() in ["txt", "riverd"]:
...
def _build_mapping_frame(parent: tk.Widget, source_dict: dict,
    ...
    # Header row
    tk.Label(inner, text="Source field", font=FONT_B,
